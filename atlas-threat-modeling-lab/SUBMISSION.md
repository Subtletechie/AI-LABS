...
2. **Indirect vs. direct injection**: How is indirect prompt injection through the knowledge base different from a direct prompt injection typed by the user? Why does the indirect path make the attack harder to detect and filter?

3. **Highest-leverage control**: Which single control would reduce the most risk for this system, and why? Consider how many of your top threats it partially or fully mitigates.

---

> Note: Do not include an answer key in your submission. Instructors maintain the answer key separately.
